...
import { ConfigureModuleResult, ConfigureProviderResult } from "../../types/plugin/outputs"
import { ConfigureModuleParams, DeleteServiceParams, GetServiceLogsParams } from "../../types/plugin/params"
...
import { DeployServiceParams, GetServiceStatusParams, BuildModuleParams } from "../../types/plugin/params"
...
async function configureProvider(
  { config, projectName, dependencies, configStore }: ConfigureProviderParams<OpenFaasConfig>,
...
async function configureModule(
  { ctx, moduleConfig }: ConfigureModuleParams<OpenFaasModule>,
